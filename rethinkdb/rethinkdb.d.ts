...
declare module rethinkdb {
  ...
  interface TableOptions {
    ...
    durability?: string;
    shards?: number;
    replicas?: number|{[tags: string]: number};
  ...
  export interface RInterface extends RExpressionInterface {
    ...
    *     }).run(conn, callback);
     ...
     */
    info(arg: RAnyInterface):RObjectInterface<any>;
     ...
     */
    typeOf(arg: RAnyInterface):RStringInterface;
  ...
  export interface RSequenceArrayInterface extends RSequenceInterface, RRunableInterface<Array<any>> {
    ...
    *     }).run(conn, callback)
     ...
     */
    concatMap<T>(mapFunction:ExpressionFunction<RObjectInterface<any>, T>|RValueInterface<T>):RSequenceStream<T>;  //RValueInterface<T> is for r.row('...') shortcut
  ...
  export interface RSequenceStream<RemoteT> extends RSequenceInterface, RRunableInterface<RCursorInterface<RemoteT>> { // '&' is a workaround so I can use both cursor or array interfaces after run (in rethinkdbdash it returns arrays by default)
    ...
    (index:number|RNumberInterface):RSingleSelectionInterface<RemoteT>;
    ...
    *     }).run(conn, callback);
     ...
     * http://rethinkdb.com/api/javascript/map
     */
    map<T extends RAnyInterface>(...arrays_and_then_a_function:Array<RArrayInterface|Array<any>|ExpressionFunction<T, RAnyInterface|Object>|RAnyInterface>):RStreamInterface<any>;
    map<T extends RAnyInterface>(...sequences_and_then_a_function:Array<RSequenceInterface|Array<any>|ExpressionFunction<T, RAnyInterface|Object>|RAnyInterface>):RStreamInterface<any>;
    map<T extends RAnyInterface>(a_function:ExpressionFunction<T, RAnyInterface|Object>|RAnyInterface):RStreamInterface<any>;
    map<T extends RAnyInterface>(array1:RArrayInterface|Array<any>, ...arrays_and_then_a_function:Array<RArrayInterface|Array<any>|ExpressionFunction<T, RAnyInterface|Object>|RAnyInterface>):RStreamInterface<any>;
    map<T extends RAnyInterface>(array1:RArrayInterface|Array<any>, a_function:ExpressionFunction<T, RAnyInterface|Object>|RAnyInterface):RStreamInterface<any>;
  ...
  export interface RSequenceInterface extends RCoercable, RToJSONInterface, RAnyInterface {
    ...
    *     }).run(conn, callback)
     ...
     */
    forEach<T extends RAnyInterface>(write_function:ExpressionFunction<T, RObjectInterface<WriteResult>>):RObjectInterface<WriteResult>;
     ...
     */
    group(field:string|RStringInterface, options?:{ index?, multi? }):RGroupedStreamInterface<any>;
    group(func:ExpressionFunction<RObjectInterface<any>, any>, options?:{ index?, multi? }):RGroupedStreamInterface<any>;
    ...
    *     }).run(conn, callback);
     ...
     */
    slice(startIndex:number|RNumberInterface, endIndex:number|RNumberInterface, options?:{ leftBound?, rightBound? }):this;
    slice(startIndex:number|RNumberInterface):this;
     ...
     */
    limit(n:number|RNumberInterface):this;
     ...
     */
    skip(n:number|RNumberInterface):this;
     ...
     */
    without(...selectors:Array<Object>):this;
  }
  ...
  export interface RValueInterface<RemoteT> extends RCoercable, RRunableInterface<RemoteT>, RToJSONInterface, RAnyInterface {
    ...
    *     }).run(conn, callback);
     ...
     * http://rethinkdb.com/api/javascript/default
     */
    default(default_value:this|RemoteT):this;
    default(predicate_function:ExpressionFunction<RValueInterface<RemoteT>, Object|RAnyInterface>):this;
  ...
  interface RCoercable {
    ...
    *     }).run(conn, callback)
     ...
     */
    coerceTo(type: 'array'): RArrayInterface;
    coerceTo(type: 'object'): RObjectInterface<any>;
    coerceTo(type: 'string'): RStringInterface;
    coerceTo(type: 'number'): RNumberInterface;
    coerceTo(type: 'binary'): RBinaryInterface;
    coerceTo(type: string): RAnyInterface;
  }
  ...
  export interface RDbInterface extends RAnyInterface {
     ...
     * http://rethinkdb.com/api/javascript/table_create
     */
    tableCreate(tableName:string|RStringInterface, options?: TableOptions):RObjectInterface<any>;
  ...
  export interface RGroupedStreamInterface<RemoteT> extends RGroupedValueInterface<Array<RemoteT>> { //, RValueInterface<RCursorInterface<GroupResult>>
//RSequenceInterface
    /**
     * Averages all the elements of a sequence. If called with a field name, averages all the values of that field in the sequence, skipping elements of the sequence that lack that field. If called with a function, calls that function on every element of the sequence and averages the results, skipping elements of the sequence where that function returns `null` or a non-existence error.
     *
     ...
     * http://rethinkdb.com/api/javascript/avg
     */
    avg():RGroupedValueInterface<number>;
    avg(field:string|RStringInterface):RGroupedValueInterface<number>;
    avg(func:Function):RGroupedValueInterface<number>;
     ...
     * http://rethinkdb.com/api/javascript/contains
     */
    contains(...functions:Array<ExpressionFunction<RObjectInterface<any>, RAnyInterface|Object>>):RGroupedValueInterface<boolean>;
    contains(...values:Array<string>):RGroupedValueInterface<boolean>;
     ...
     * http://rethinkdb.com/api/javascript/count
     */
    count(predicate_function:ExpressionFunction<RObjectInterface<any>, RAnyInterface|Object>):RGroupedValueInterface<number>;
    count(value?:any):RGroupedValueInterface<number>;
    ...
    *     }).run(conn, callback);
     ...
     * http://rethinkdb.com/api/javascript/default
     */
    default(default_value):this;
    default(predicate_function:ExpressionFunction<RObjectInterface<any>, Object|RAnyInterface>):this;
    ...
    *     }).run(conn, callback)
     ...
     * http://rethinkdb.com/api/javascript/for_each
     */
    forEach<T extends RAnyInterface>(write_function:ExpressionFunction<T, RObjectInterface<WriteResult>>):RGroupedValueInterface<WriteResult>;
     ...
     * http://rethinkdb.com/api/javascript/group
     */
    //TODO: find a way to group a groupped stream
     ...
     * http://rethinkdb.com/api/javascript/is_empty
     */
    isEmpty():RGroupedValueInterface<boolean>;
     ...
     * http://rethinkdb.com/api/javascript/max
     */
    max(field_or_a_function:string|RStringInterface|Function):RGroupedValueInterface<RemoteT>;
    max(options?:{ index? }):RGroupedValueInterface<RemoteT>;
     ...
     * http://rethinkdb.com/api/javascript/min
     */
    min(field_or_a_function:string|RStringInterface|Function):RGroupedValueInterface<RemoteT>;
    min(options?:{ index? }):RGroupedValueInterface<RemoteT>;
     ...
     * http://rethinkdb.com/api/javascript/nth
     */
    nth(index:number|RNumberInterface):RGroupedValueInterface<RemoteT>;
     ...
     * http://rethinkdb.com/api/javascript/offsets_of
     */
    offsetsOf(predicate_function:Function):RGroupedStreamInterface<number>; // TODO
    offsetsOf(datum:string|RStringInterface):RGroupedStreamInterface<number>;
    ...
    *     }).run(conn, callback);
     ...
     * http://rethinkdb.com/api/javascript/reduce
     */
    reduce(a_function:ReduceFunction<any>):RGroupedValueInterface<any>;
     ...
     * http://rethinkdb.com/api/javascript/sum
     */
    sum(field_or_a_function?:string|RStringInterface|Function):RGroupedValueInterface<number>;
     ...
     * http://rethinkdb.com/api/javascript/bracket
     */
    (attr:string|RStringInterface):RGroupedStreamInterface<any>;
    (index:number|RNumberInterface):RGroupedValueInterface<RemoteT>;
    ...
    *     }).run(conn, callback)
     ...
     * http://rethinkdb.com/api/javascript/concat_map
     */
    concatMap<T>(mapFunction:ExpressionFunction<RObjectInterface<any>, T>|RValueInterface<T>):RGroupedStreamInterface<T>;  //RValueInterface<T> is for r.row('...') shortcut
    ...
    *     }).distinct().run(conn, callback)
     ...
     * http://rethinkdb.com/api/javascript/distinct
     */
    distinct(options?:{index?:string|RStringInterface}):RGroupedStreamInterface<RemoteT>;
     ...
     * http://rethinkdb.com/api/javascript/eq_join
     */
    eqJoin<RightT>(leftField:string|RStringInterface, rightTable:RTableInterface<RightT>, options?:{ index? }):RGroupedStreamInterface<JoinResult<RemoteT, RightT>>;
    eqJoin<RightT>(predicate_function:ExpressionFunction<RObjectInterface<any>, RAnyInterface|Object>, rightTable:RTableInterface<RightT>, options?:{ index? }):RGroupedStreamInterface<JoinResult<RemoteT, RightT>>;
     ...
     * http://rethinkdb.com/api/javascript/filter
     */
    filter(predicate_function:ExpressionFunction<RObjectInterface<any>, RBoolInterface>, options?:{ default?:boolean }):RGroupedStreamInterface<RemoteT>;
    filter(filterByObject:Object):RGroupedStreamInterface<RemoteT>;
     ...
     * http://rethinkdb.com/api/javascript/get_field
     */
    getField(attr:string|RStringInterface):RGroupedStreamInterface<any>;
     ...
     * http://rethinkdb.com/api/javascript/has_fields
     */
    hasFields(...selectors:Array<string|RStringInterface>):RGroupedStreamInterface<RemoteT>;
     ...
     * http://rethinkdb.com/api/javascript/includes
     */
    includes(geometry):RGroupedStreamInterface<RemoteT>;
    ...
    *     }).zip().run(conn, callback)
     ...
     * http://rethinkdb.com/api/javascript/inner_join
     */
    innerJoin(otherSequence:RSequenceInterface, predicate_function:JoinFunction<RBoolInterface>):RGroupedStreamInterface<JoinResult<RemoteT, any>>;
     ...
     * http://rethinkdb.com/api/javascript/intersects
     */
    intersects(geometry):RGroupedStreamInterface<RemoteT>;
    ...
    *     }).run(conn, callback);
     ...
     * http://rethinkdb.com/api/javascript/map
     */
    map<T extends RAnyInterface>(...arrays_and_then_a_function:Array<RArrayInterface|Array<any>|ExpressionFunction<T, RAnyInterface|Object>|RAnyInterface>):RGroupedStreamInterface<any>;
    map<T extends RAnyInterface>(...sequences_and_then_a_function:Array<RSequenceInterface|Array<any>|ExpressionFunction<T, RAnyInterface|Object>|RAnyInterface>):RGroupedStreamInterface<any>;
    map<T extends RAnyInterface>(a_function:ExpressionFunction<T, RAnyInterface|Object>|RAnyInterface):RGroupedStreamInterface<any>;
    map<T extends RAnyInterface>(array1:RArrayInterface|Array<any>, ...arrays_and_then_a_function:Array<RArrayInterface|Array<any>|ExpressionFunction<T, RAnyInterface|Object>|RAnyInterface>):RGroupedStreamInterface<any>;
    map<T extends RAnyInterface>(array1:RArrayInterface|Array<any>, a_function:ExpressionFunction<T, RAnyInterface|Object>|RAnyInterface):RGroupedStreamInterface<any>;
     ...
     * http://rethinkdb.com/api/javascript/merge
     */
    merge(...object_or_a_functions:Array<Object|Function>):RGroupedStreamInterface<any>;
     ...
     * http://rethinkdb.com/api/javascript/order_by
     */
    orderBy(key_or_a_function, options?:{ index }):RGroupedStreamInterface<RemoteT>;
    orderBy(key_or_a_function, ...more):RGroupedStreamInterface<RemoteT>;
    orderBy(key_or_a_function):RGroupedStreamInterface<RemoteT>;
    orderBy(options:{ index }):RGroupedStreamInterface<RemoteT>;
    ...
    *     }).run(conn, callback)
     ...
     * http://rethinkdb.com/api/javascript/outer_join
     */
    outerJoin(otherSequence:RSequenceInterface, predicate_function:JoinFunction<RBoolInterface>):RGroupedStreamInterface<JoinResult<RemoteT, any>>;
     ...
     */
    // TODO
    sample(number:number|RNumberInterface):RGroupedStreamInterface<RemoteT>;
     ...
     * http://rethinkdb.com/api/javascript/union
     */
    union(sequence:RSequenceInterface, ...sequences:Array<RSequenceInterface>):RGroupedStreamInterface<any>;
    union(sequence:RSequenceInterface):RGroupedStreamInterface<any>;
     ...
     * http://rethinkdb.com/api/javascript/with_fields
     */
    withFields(...selectors:Array<string>):RGroupedStreamInterface<RemoteT>;
    //RStreamInterface<RemoteT>
     ...
     * http://rethinkdb.com/api/javascript/pluck
     */
    pluck(...selectors:Array<string>):RGroupedStreamInterface<RemoteT>;
     ...
     * http://rethinkdb.com/api/javascript/zip
     */
    zip():RGroupedStreamInterface<any>;
  }
